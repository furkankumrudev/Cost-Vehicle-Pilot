...
export function MarketTrendsPage() {
  ...
  return <main>
    <section className="hero"><div className="shell">
      ...
      <p>Türkiye ikinci el araç ilanlarından oluşturulan güncel piyasa fiyatlarını, değişimleri ve araç karşılaştırmalarını inceleyin.</p>
    </div></section>
    <div className="shell page-content">
      <MarketSummary data={overview} loading={loading} />
      <VehicleFilters value={filters} onApply={setFilters} />
      <MarketMovers />
